        ...
        NavigationStack {
            ZStack {
                ...
                if isLoading && windows.isEmpty {
                    DeckHandLoadingStateView(title: "Reading windows from Mac…")
        ...
        VStack(spacing: 12) {
            ...
            Button {
                ...
                Label("Refresh", systemImage: "arrow.clockwise")
                    ...
                    .padding(.vertical, 8)
                    .background(
                        Capsule().fill(DeckHandTheme.violet.opacity(0.18))
                    )
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 14, style: .continuous)
                .fill(DeckHandTheme.subtleWellFill(colorScheme).opacity(0.6))
                .overlay(
                    RoundedRectangle(cornerRadius: 14, style: .continuous)

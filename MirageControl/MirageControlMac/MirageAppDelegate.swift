...
@MainActor
final class MirageAppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        item.autosaveName = "MirageControlStatusItem"
        ...
        if let button = item.button {
            let image = NSImage(
                ...
                accessibilityDescription: "MirageControl"
            )
